#!/usr/bin/env python3
"""
Recupero codici sconto YOOX Italia da shopilo.it
Sursa: https://shopilo.it/negozi/yoox.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/yoox.it"
STORE_NAME = "YOOX Italia"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per YOOX Italia da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-yoox-it)"
    }
    try:
